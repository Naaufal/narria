...
<div class="section-header ml-auto shadow">
    <div class="section-header-back">
        <a href="<?=site_url('admin/novels')?>" class="btn"><i class="fas fa-arrow-left"></i></a>
    </div>
    <h1>Upload Novel</h1>
</div>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('admin/novel/store') ?>" method="post" enctype="multipart/form-data" id="novelForm">
                    <?= csrf_field() ?>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label for="author_id">Penulis <span class="text-danger">*</span></label>
                                <select class="form-control <?= session()->getFlashdata('errors')['author_id'] ?? false ? 'is-invalid' : '' ?>" 
                                ...
                                <div class="invalid-feedback">
                                    <?= session()->getFlashdata('errors')['author_id'] ?? '' ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control <?= session()->getFlashdata('errors')['status'] ?? false ? 'is-invalid' : '' ?>" 
                                    ...
                                    <option value="hiatus" <?= old('status') == 'hiatus' ? 'selected' : '' ?>>
                                        <i class="fas fa-pause-circle"></i> Hiatus
                                    </option>
                                </select>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="border rounded p-3 text-center bg-light">
                                    ...
                                    <div id="no-preview" class="text-muted">
                                        ...
                                        <small>Ukuran ideal: 300x400px</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Kategori Terpilih <span id="category-count" class="badge badge-primary">0</span></label>
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="<?= base_url('admin/novels') ?>" class="btn btn-outline-secondary btn-lg">
