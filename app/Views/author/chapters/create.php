    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= site_url('author/novels/' . $novel->id . '/chapters') ?>" method="POST">
                        <?= csrf_field() ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="chapter_number" name="chapter_number" 
                                           value="<?= old('chapter_number', $nextChapterNumber) ?>" min="1" required>
                                    <small class="form-text text-muted">Nomor chapter yang disarankan: <?= $nextChapterNumber ?></small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
